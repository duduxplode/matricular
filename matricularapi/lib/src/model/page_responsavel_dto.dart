...
part 'page_responsavel_dto.g.dart';
...
abstract class PageResponsavelDTO
    implements Built<PageResponsavelDTO, PageResponsavelDTOBuilder> {
  ...
  BuiltList<ResponsavelDTO>? get content;
  ...
  PageResponsavelDTO._();

  factory PageResponsavelDTO([void updates(PageResponsavelDTOBuilder b)]) =
      _$PageResponsavelDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageResponsavelDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageResponsavelDTO> get serializer =>
      _$PageResponsavelDTOSerializer();
}

class _$PageResponsavelDTOSerializer
    implements PrimitiveSerializer<PageResponsavelDTO> {
  @override
  final Iterable<Type> types = const [PageResponsavelDTO, _$PageResponsavelDTO];

  @override
  final String wireName = r'PageResponsavelDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PageResponsavelDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PageResponsavelDTOBuilder result,
  ...
  @override
  PageResponsavelDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageResponsavelDTOBuilder();
