...
part of 'page_responsavel_dto.dart';
...
class _$PageResponsavelDTO extends PageResponsavelDTO {
  ...
  final int? size;
  @override
  final BuiltList<ResponsavelDTO>? content;
  @override
  final int? number;
  @override
  ...
  factory _$PageResponsavelDTO(
          [void Function(PageResponsavelDTOBuilder)? updates]) =>
  ...
  @override
  PageResponsavelDTO rebuild(
          void Function(PageResponsavelDTOBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PageResponsavelDTOBuilder toBuilder() =>
      new PageResponsavelDTOBuilder()..replace(this);
...
class PageResponsavelDTOBuilder
  ...
  ListBuilder<ResponsavelDTO>? _content;
  ListBuilder<ResponsavelDTO> get content =>
      _$this._content ??= new ListBuilder<ResponsavelDTO>();
  set content(ListBuilder<ResponsavelDTO>? content) =>
  ...
  PageResponsavelDTOBuilder() {
    PageResponsavelDTO._defaults(this);
  }
  ...
  @override
  void replace(PageResponsavelDTO other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PageResponsavelDTO;
  }

  @override
  void update(void Function(PageResponsavelDTOBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PageResponsavelDTO build() => _build();

  _$PageResponsavelDTO _build() {
    _$PageResponsavelDTO _$result;
    try {
      _$result = _$v ??
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PageResponsavelDTO', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
