...
abstract class PageUsuarioDTO
    implements Built<PageUsuarioDTO, PageUsuarioDTOBuilder> {
  ...
  BuiltList<UsuarioDTO>? get content;
  ...
  factory PageUsuarioDTO([void updates(PageUsuarioDTOBuilder b)]) =
      _$PageUsuarioDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageUsuarioDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageUsuarioDTO> get serializer =>
      _$PageUsuarioDTOSerializer();
}

class _$PageUsuarioDTOSerializer
    implements PrimitiveSerializer<PageUsuarioDTO> {
  @override
  final Iterable<Type> types = const [PageUsuarioDTO, _$PageUsuarioDTO];

  @override
  final String wireName = r'PageUsuarioDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PageUsuarioDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PageUsuarioDTOBuilder result,
  ...
  @override
  PageUsuarioDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageUsuarioDTOBuilder();
