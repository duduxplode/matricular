...
/// * [empty]
@BuiltValue()
abstract class PageTurmaDTO
    implements Built<PageTurmaDTO, PageTurmaDTOBuilder> {
  ...
  BuiltList<TurmaDTO>? get content;
  ...
  factory PageTurmaDTO([void updates(PageTurmaDTOBuilder b)]) = _$PageTurmaDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageTurmaDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageTurmaDTO> get serializer => _$PageTurmaDTOSerializer();
}

class _$PageTurmaDTOSerializer implements PrimitiveSerializer<PageTurmaDTO> {
  @override
  final Iterable<Type> types = const [PageTurmaDTO, _$PageTurmaDTO];

  @override
  final String wireName = r'PageTurmaDTO';
  ...
  void _deserializeProperties(
    ...
    required PageTurmaDTOBuilder result,
  ...
  @override
  PageTurmaDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageTurmaDTOBuilder();
