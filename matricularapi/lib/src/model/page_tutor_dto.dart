...
/// * [empty]
@BuiltValue()
abstract class PageTutorDTO
    implements Built<PageTutorDTO, PageTutorDTOBuilder> {
  ...
  BuiltList<TutorDTO>? get content;
  ...
  factory PageTutorDTO([void updates(PageTutorDTOBuilder b)]) = _$PageTutorDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageTutorDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageTutorDTO> get serializer => _$PageTutorDTOSerializer();
}

class _$PageTutorDTOSerializer implements PrimitiveSerializer<PageTutorDTO> {
  @override
  final Iterable<Type> types = const [PageTutorDTO, _$PageTutorDTO];

  @override
  final String wireName = r'PageTutorDTO';
  ...
  void _deserializeProperties(
    ...
    required PageTutorDTOBuilder result,
  ...
  @override
  PageTutorDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageTutorDTOBuilder();
