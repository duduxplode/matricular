...
part 'page_advertencia_dto.g.dart';
...
/// * [empty]
@BuiltValue()
abstract class PageAdvertenciaDTO
    implements Built<PageAdvertenciaDTO, PageAdvertenciaDTOBuilder> {
  ...
  BuiltList<AdvertenciaDTO>? get content;
  ...
  PageAdvertenciaDTO._();

  factory PageAdvertenciaDTO([void updates(PageAdvertenciaDTOBuilder b)]) =
      _$PageAdvertenciaDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageAdvertenciaDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageAdvertenciaDTO> get serializer =>
      _$PageAdvertenciaDTOSerializer();
}

class _$PageAdvertenciaDTOSerializer
    implements PrimitiveSerializer<PageAdvertenciaDTO> {
  @override
  final Iterable<Type> types = const [PageAdvertenciaDTO, _$PageAdvertenciaDTO];

  @override
  final String wireName = r'PageAdvertenciaDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PageAdvertenciaDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PageAdvertenciaDTOBuilder result,
  ...
  @override
  PageAdvertenciaDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageAdvertenciaDTOBuilder();
