...
class UsuarioControllerApi {
  ...
  const UsuarioControllerApi(this._dio, this._serializers);
  ...
  Future<Response<UsuarioDTO>> usuarioControllerAlterar({
    required int id,
    ...
    final _path = r'/api/v1/usuario/{id}'.replaceAll('{' r'id' '}',
    ...
    try {
      const _type = FullType(UsuarioDTO);
      _bodyData = _serializers.serialize(usuarioDTO, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> usuarioControllerCount({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/usuario/pagination';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UsuarioDTO>> usuarioControllerIncluir({
    ...
    final _path = r'/api/v1/usuario/singup';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageUsuarioDTO>> usuarioControllerListAllPage({
    ...
    final _path = r'/api/v1/usuario/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> usuarioControllerListAllWithSort({
    ...
    final _path = r'/api/v1/usuario/sort/{field}'.replaceAll(
        '{' r'field' '}',
        encodeQueryParameter(_serializers, field, const FullType(String))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> usuarioControllerListUsuariosWithPagination({
    required int offset,
    ...
    final _path = r'/api/v1/usuario/pagination/{offset}/{pageSize}'
        .replaceAll(
            '{' r'offset' '}',
  ...
  Future<Response<UsuarioDTO>> usuarioControllerNovoAlterar({
    ...
    final _path = r'/api/v1/usuario/alterar/{id}'.replaceAll('{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
    ...
    try {
      const _type = FullType(UsuarioAlterarDTO);
      _bodyData =
          _serializers.serialize(usuarioAlterarDTO, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<String>> usuarioControllerRedefinirSenha({
    ...
    final _path = r'/api/v1/usuario/redefinir-senha';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<UsuarioDTO>>> usuarioControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/usuario/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageUsuarioDTO>> usuarioControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/usuario/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SearchField>>> usuarioControllerSearchFieldsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
