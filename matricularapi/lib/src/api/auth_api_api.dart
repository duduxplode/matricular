...
class AuthAPIApi {
  ...
  const AuthAPIApi(this._dio, this._serializers);
  ...
  Future<Response<CredencialDTO>> getInfoByToken({
    ...
    final _path = r'/api/v1/auth/info';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<bool>>> getInfoByTokenValidacao({
    String? requestToken,
    ...
    final _path = r'/api/v1/auth/senha/solicitacao/info';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (requestToken2 != null) r'Request-Token': requestToken2,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[
    ...
    final _queryParameters = <String, dynamic>{
      if (requestToken != null)
        r'requestToken': encodeQueryParameter(
            _serializers, requestToken, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [CredencialDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CredencialDTO>> login({
    ...
    try {
      const _type = FullType(AuthDTO);
      _bodyData = _serializers.serialize(authDTO, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CredencialDTO>>> recuperarSenha({
    ...
    final _path = r'/api/v1/auth/senha/solicitacao/{email}'.replaceAll(
        '{' r'email' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CredencialDTO>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CredencialDTO>>> redefinirSenha({
    required UsuarioSenhaDTO usuarioSenhaDTO,
    String? requestToken,
    String? requestToken2,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/auth/senha';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        if (requestToken2 != null) r'Request-Token': requestToken2,
    ...
    try {
      const _type = FullType(UsuarioSenhaDTO);
      _bodyData = _serializers.serialize(usuarioSenhaDTO, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CredencialDTO>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CredencialDTO>>> refresh({
    ...
    final _queryParameters = <String, dynamic>{
      r'refreshToken': encodeQueryParameter(
