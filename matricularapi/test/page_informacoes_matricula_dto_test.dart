...
// tests for PageInformacoesMatriculaDTO
void main() {
  final instance = PageInformacoesMatriculaDTOBuilder();
  // TODO add properties to the builder and call build()

  group(PageInformacoesMatriculaDTO, () {
    // int totalPages
    ...
    // BuiltList<InformacoesMatriculaDTO> content
