...
// tests for PageNecessidadeEspecialDTO
void main() {
  final instance = PageNecessidadeEspecialDTOBuilder();
  // TODO add properties to the builder and call build()

  group(PageNecessidadeEspecialDTO, () {
    // int totalPages
    ...
    // BuiltList<NecessidadeEspecialDTO> content
